...
public class product {
    ...
    public String toString() {
        return "product{" + "id=" + id + ", name=" + name + ", description=" + description + ", price=" + price + ", quality=" + quality + ", url_img1=" + url_img1 + ", url_img2=" + url_img2 + ", url_img3=" + url_img3 + ", url_img4=" + url_img4 + ", url_img5=" + url_img5 + ", categoryID=" + categoryID + ", brandID=" + brandID + ", code=" + code + ", date=" + date + '}';
    }
